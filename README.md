...
To handle this case, we will add *dl_updated_at* column for each of our tables indicating *data processing time* that we wil use as filter criteria to capture both new and late arriving data. This column is also used as a partition column in our tables.
